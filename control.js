...
var ocoords = [29.801905, -95.365827];
...
function make(test){
 ...
 //   console.log("unix", events[i].attributes.Time_Begun, "time", time);
     ...
     if ( events[i].attributes.Offense == "Theft" )
      { 
       ...
       { 
        ...
        burglaries = L.layerGroup()
        .addLayer(L.Marker([latlng.lat, latlng.lng], {icon: Robbery},{bounceOnAdd: true}).bindPopup(customPopup,customOptions))
        .addTo(mymap);
    ...
    layerControl.addOverlay(burglaries, "Burglaries");

         
    return false;
}  
      //  bluecnt = bluecnt + 1;
      //  var james = new L.Marker([latlng.lat, latlng.lng]).bindPopup(customPopup,customOptions);
      //  console.log(james);       
      //  blues[bluecnt] = james;       
     //  }
...
/*
var burglaries = L.layerGroup(blues); 
 
 var overlayMaps = {
 	"Burglaries":burglaries,
  "<img src='https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-blue.png' height=24>Burglary": bLayer,
  "<img src='https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-red.png' height=24>Robbery": rLayer
}
